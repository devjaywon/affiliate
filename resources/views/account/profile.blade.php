    ...
    <main>
        ...
        <div class="profile-container">
            ...
            <div class="profile-pics-file-container">
                ...
                <a class="upload-btn" href=""><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div class="kyc-container1">
                <p>KYC</p>
                <label for="kyc"> Document Type </label> <br>
                <select id="cars">
                    <option value="PVC" selected disabled >Choose Document Type</option>
            ...
            <div class="kyc-container2">
                <p>KYC</p>
                <label for="kyc"> Document Type </label> <br>
                <select id="cars">
                    <option value="hgjng">v</option>
        ...
        <div class="links-container">
            <div class="links-container-content">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="svg-image">
                  ...
                  </svg> <a href="{{ route('dashboard') }}">Dashboard</a>
            </div>
            ...
            <div class="links-container-content1">
                <div class="linksss">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="svg-image">
                       ...
                       <a class="my-account" href="{{ route('account.index') }}">My Account <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="svg-image1">
            ...
            <div class="links-container-content">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="svg-image">
                   ...
                   <a href="{{ route('account.index') }}">Affiliate Materials</a>
            </div>
