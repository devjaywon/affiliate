...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pay.pay', compact('gateways'));
    }
    ...
    public function success($ref = null)
    {
        ...
        return view('pay.success', compact("ref"))->with("msg", "Payment made successfully using this reference.");
    ...
    public function cancel($ref = null)
    {
        ...
        return view('pay.error', compact("ref"))->with("msg", "Payment was not successful using this reference.");
    }
